    ...
    <div className={`relative inline-block ${className}`}>
      <Image
        ...
        onError={e => {
          ...
          fallback.className =
            'flex items-center justify-center bg-gray-200 text-gray-500 text-xs font-medium rounded-sm';
...
export function getIngredientEmoji(ingredient: string): string {
  ...
  // Fruits
  if (lowerIngredient.includes('apple') || lowerIngredient.includes('fruit'))
    return '🍎';
  if (lowerIngredient.includes('banana')) return '🍌';
  if (lowerIngredient.includes('orange') || lowerIngredient.includes('citrus'))
    return '🍊';
  if (lowerIngredient.includes('lemon') || lowerIngredient.includes('lime'))
    return '🍋';
  if (lowerIngredient.includes('grape')) return '🍇';
  if (
    lowerIngredient.includes('strawberry') ||
  ...
  if (
    ...
    lowerIngredient.includes('sweet potato')
  )
    return '🥔';
  ...
  if (
    ...
    lowerIngredient.includes('bell pepper')
  )
    return '🫑';
  if (lowerIngredient.includes('cucumber')) return '🥒';
  if (lowerIngredient.includes('lettuce') || lowerIngredient.includes('salad'))
    return '🥬';
  ...
  if (
    ...
    lowerIngredient.includes('poultry')
  )
    return '🐔';
  if (lowerIngredient.includes('beef') || lowerIngredient.includes('steak'))
    return '🥩';
  ...
  if (
    ...
    return '🐟';
  if (lowerIngredient.includes('shrimp') || lowerIngredient.includes('prawn'))
    return '🦐';
  ...
  // Grains & Bread
  if (lowerIngredient.includes('bread') || lowerIngredient.includes('toast'))
    return '🍞';
  if (lowerIngredient.includes('rice')) return '🍚';
  if (lowerIngredient.includes('pasta') || lowerIngredient.includes('noodle'))
    return '🍝';
  ...
  if (
    ...
    return '🥜';
  if (lowerIngredient.includes('seed') || lowerIngredient.includes('sesame'))
    return '🌰';

  // Herbs & Spices
  if (
    lowerIngredient.includes('herb') ||
    lowerIngredient.includes('basil') ||
    lowerIngredient.includes('oregano')
  )
    return '🌿';
  if (
  ...
  // Oils & Condiments
  if (lowerIngredient.includes('oil') || lowerIngredient.includes('olive'))
    return '🫒';
  if (lowerIngredient.includes('vinegar')) return '🍶';
  if (lowerIngredient.includes('soy') || lowerIngredient.includes('sauce'))
    return '🍶';
  if (lowerIngredient.includes('ketchup')) return '🍅';
  if (lowerIngredient.includes('mustard')) return '🟡';
  if (
    lowerIngredient.includes('mayonnaise') ||
    lowerIngredient.includes('mayo')
  )
    return '🥄';

  // Sweet & Desserts
  if (lowerIngredient.includes('sugar') || lowerIngredient.includes('sweet'))
    return '🍯';
  if (
